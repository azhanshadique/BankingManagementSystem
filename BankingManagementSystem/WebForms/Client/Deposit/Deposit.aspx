<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/WebForms/MasterPage.Master" AutoEventWireup="true" CodeBehind="Deposit.aspx.cs" Inherits="BankingManagementSystem.WebForms.Client.Deposit.Deposit" %>
        ...
        <div class="card shadow rounded-4">
            <div class="card-body px-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                    ...
                    <h2 class="text-center flex-grow-1 mb-0">Deposit Money</h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label for="txtAmount" class="form-label">Amount to Deposit<span class="text-danger">*</span></label>
